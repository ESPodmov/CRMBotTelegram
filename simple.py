...
async def handler(request):
    ...
    if message_type == "text":
        ...
        input_file = ""
        # input_file = aiogram.types.InputFile.from_url(message_media, message_file_name)
...
async def select_worker_edit_to(callback: types.CallbackQuery):  # вставить это в основной код
    try:
        dict_line = "workers"
